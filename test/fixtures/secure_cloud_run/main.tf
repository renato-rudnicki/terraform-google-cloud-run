...
module "example_cloud_run" {
  ...
  vpc_connector_id                        = "projects/prj-p-shared-restricted-1552/locations/us-central1/connectors/serverless-connector"
  encryption_key                          = "projects/prj-bu2-p-env-secrets-f06c/locations/us-central1/keyRings/cloud-run-keyring07/cryptoKeys/cloud-run07"
}
